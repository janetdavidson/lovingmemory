<template>
  <div class="container">
    ...
    <div class="section obituary section-70">
      ...
      <div class="text">
        Online condolences can be added to <a target="_blank" href="https://memorials.affordablefuneralservices.com/janet-davidson/4642107/obituary.php">Affordable Funeral Services' webpage for Janet Davidson</a> by clicking the <span "class=bold">Memory Wall</span> tab, located underneath Jan's photo.
      </div>
      <div class="image">
